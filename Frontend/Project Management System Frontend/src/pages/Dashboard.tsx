...
const Dashboard = () => {
  ...
  const [viewerProjects, setViewerProjects] = useState<Project[]>([]);
  ...
  return (
    ...
    <div className="dashboard-container">
      <div className="dashboard-header">
        <h1>{(user as { username: string })?.username}'s Dashboard</h1>
      </div>
            ...
            <section className="recent-projects">
              ...
              <div className="project-list">
                {adminProjects.length || memberProjects.length || viewerProjects.length ? (
                  <ul>
                    {[
                      ...adminProjects.slice(0, 3),
                      ...memberProjects.slice(0, 3),
                      ...viewerProjects.slice(0, 3),
                    ].map((project) => (
                      <li key={project.id}>
                        <h3>{project.title}</h3>
                      </li>
